...
public class MarkingActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		UnityAds.initialize(MarkingActivity.this,UnityAdsConfig.UnityAdsAppID,UnityAdsConfig.TestModeON);
		...
		UnityAdsConfig.loadAndShowUnityBannerAds(MarkingActivity.this,bannerAdContainer);
	...
	private void initializeLogic() {
		setTitle("Marking Scheme");
		webview1.loadUrl("https://etguru.simdif.com/marking-scheme.html");
	...
	protected void onStart() {
		...
		UnityAdsConfig.showUnityBannerAd(MarkingActivity.this,bannerAdContainer);
		UnityAdsConfig.showUnityInterstitialAd(MarkingActivity.this);
		super.onStart();
	}
